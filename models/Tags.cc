...
Tags::Tags(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[0].empty() && pJson.isMember(pMasqueradingVector[0]))
    {
        ...
        {
            tagId_=std::make_shared<int32_t>((int32_t)pJson[pMasqueradingVector[0]].asInt64());
        }
    }
...
const int32_t &Tags::getValueOfTagId() const noexcept
{
...
const std::shared_ptr<int32_t> &Tags::getTagId() const noexcept
{
    return tagId_;
}
void Tags::setTagId(const int32_t &pTagId) noexcept
{
...
{
    tagId_ = std::make_shared<int32_t>(static_cast<int32_t>(id));
}
